...
{   
    ...
    LibraryViewController *libraryViewController = [storyboard instantiateViewControllerWithIdentifier:@"LibraryViewController"];
    libraryViewController.dataObject = self.pageData[index];
...
/*- (UIViewController *)viewControllerAtIndex:(NSUInteger)index storyboard:(UIStoryboard *)storyboard
{
    ...
    if(index == 0) {
        ...
        bookViewController.dataObject = self.pageData[index];
...
{
    NSUInteger index = [self indexOfViewController:(LibraryViewController *)viewController];
