...
- (void)cancle
{
    [self hidenKeyboard:^(BOOL finished) {
        ...
        [UIAlertView showWithTitle:@"Confirm Cancellation?" message:nil delegate:self cancelButtonTitle:@"NO" otherButtonTitles:@"YES", nil];
    }];
}
...
- (void)showInView:(UIView *)view
{
    ...
    self.keyboard.height = ZCScreenHeight * 0.4;
    
    /** 输入框起始frame */
    self.inputView.height = ZCScreenHeight * 0.3;
    self.inputView.y = (self.height - self.inputView.height) * 0.2;
