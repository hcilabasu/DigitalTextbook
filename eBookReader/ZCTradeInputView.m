...
- (void)setupSubViews
{
    ...
    [self.okBtn primaryStyle];
    
    
    self.okBtn.tag = ZCTradeInputViewButtonTypeWithOk;
    self.okBtn.titleLabel.text=@"OK";
    /** 取消按钮 */
...
- (void)layoutSubviews
{
    ...
    [self.cancleBtn setTitle:@"Canel" forState:UIControlStateNormal];
...
- (void)drawRect:(CGRect)rect
{
    ...
    // 画字
    NSString *title = @"Input PIN number";
